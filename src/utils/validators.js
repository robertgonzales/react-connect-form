// TODO: offload REGEXP to npm modules
...
export const isRequired = (value, values) => {
...
export const isAlpha = (value, values) => {
  if (!alphaRegExp.test(value)) {
    return 'Use letters only'
  }
}

export const isNumeric = (value, values) => {
  if (isNaN(value) || !numRegExp.test(value)) {
    return 'Use numbers only'
  }
}

export const isAlphanumeric = (value, values) => {
  if (!alphaNumRegExp.test(value)) {
    return 'Use letters and numbers only'
  }
}

export const isUrl = (value, values) => {
